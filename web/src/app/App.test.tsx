...
describe("saved pages", () => {
  ...
  it("refuses a name an address cannot carry", async () => {
    ...
    // Nothing was named. The working page may or may not have been
    // flushed by the autosave in the meantime, which is a debounce race;
    // what matters is that the rejected name reached no store.
