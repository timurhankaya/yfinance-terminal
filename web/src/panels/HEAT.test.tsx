  ...
  data: [
    {
      ...
      reg_market_change_pct: "1.5",
      ytd_change_pct: "18",
      one_year_change_pct: "25",
      three_year_change_pct: "60",
      five_year_change_pct: "140",
    },
    {
      domain_key: "energy",
      as_of_date: "2026-09-08",
      market_cap: "5000000000000",
      reg_market_change_pct: "-2.5",
      ytd_change_pct: "-4",
      one_year_change_pct: "3",
      three_year_change_pct: "10",
      five_year_change_pct: "40",
    },
    ...
    // must not become a second box.
    {
      ...
      reg_market_change_pct: "0.2",
      ytd_change_pct: "17",
      one_year_change_pct: "24",
      three_year_change_pct: "59",
      five_year_change_pct: "139",
    },
    // An industry: it has metrics but is not in the sector taxonomy.
    {
      ...
      reg_market_change_pct: "1.1",
      ytd_change_pct: "12",
      one_year_change_pct: "20",
      three_year_change_pct: "50",
      five_year_change_pct: "120",
    },
  ],
  next_cursor: null,
};
